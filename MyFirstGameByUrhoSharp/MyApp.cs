    ...
    public class MyApp : Application
    {
      public  Node cameraNode;
        ...
        protected override async void Start()
        {
            ...
            var helloText1 = new Text(Context);
            helloText1.Value = "Hello World ";
            helloText1.HorizontalAlignment = HorizontalAlignment.Center;
            helloText1.VerticalAlignment = VerticalAlignment.Top;
            
            helloText1.SetColor(new Color(r: 0.5f, g: 1f, b: 1f));
            helloText1.SetFont(font: CoreAssets.Fonts.AnonymousPro, size: 30);
            UI.Root.AddChild(helloText);
